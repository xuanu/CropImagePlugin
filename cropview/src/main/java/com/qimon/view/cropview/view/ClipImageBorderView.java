package com.qimon.view.cropview.view;
...
public class ClipImageBorderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 计算距离屏幕垂直边界 的边距
        mVerticalPadding = (int) (getHeight() - mWidth / mDefaultScale) / 2;
    ...
    public void setDefaultScale(float pDefaultScale) {
        if (pDefaultScale < 1) {
            pDefaultScale = 1;
        }
        mDefaultScale = pDefaultScale;
        invalidate();
    }
